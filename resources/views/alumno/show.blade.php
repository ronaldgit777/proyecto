            ...
            <div class="card-deck">
              <div class="card2">
                <div class="card-body">
                  ...
                  <p class="card-text">CI: {{ $alumno->ci }}</p>
                  <p class="card-text">Celular: {{ $alumno->celular }}</p>
                  <p class="card-text">Correo: {{ $alumno->correo }}</p>
                  <p class="card-text">direccion: {{ $alumno->direccion }}</p>
                  <p class="card-text">Estado: {{ $alumno->estado }}</p>
